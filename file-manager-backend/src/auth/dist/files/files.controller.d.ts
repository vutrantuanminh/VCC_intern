...
export declare class FilesController {
    ...
    createFolder(req: any, createFolderDto: CreateFolderDto, ownerId?: number): Record<string, any>;
    ...
    uploadFile(req: any, file: Express.Multer.File, folderId?: number, ownerId?: number): Promise<import("./entities/file.entity").File>;
